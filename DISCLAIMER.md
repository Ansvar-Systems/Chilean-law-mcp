...
- **Professional Rules**: Members of the Colegio de Abogados de Chile must comply with applicable professional conduct rules (código de ética profesional) when using AI tools
...
1. Checking the official source (Biblioteca del Congreso Nacional de Chile — bcn.cl)
...
4. Consulting case law (jurisprudencia) and explanatory materials (historia de la ley) for interpretation
...
This Tool aggregates data from official Chilean legal databases. However:

| Source Type | Authority Level | Use Case |
|------------|----------------|----------|
| **BCN — Biblioteca del Congreso Nacional (bcn.cl)** | Authoritative | Statute text, regulations, legislative history (primary reference) |
| **Diario Oficial** | Authoritative | Official gazette publications |
| **Poder Judicial (pjud.cl)** | Authoritative for court decisions | Supreme Court and appellate jurisprudence |
...
- LegalPublishing (Thomson Reuters Chile), Abeledo Perrot Chile, or MicroJuris Chile
...
- Chilean law changes continuously through new statutes (leyes), supreme decrees (decretos supremos), regulatory instructions (instrucciones), and court decisions (fallos)
...
- Even "fresh" data may be outdated if recent amendments were published in the Diario Oficial
...
1. **Complete case law** -- Coverage of Corte Suprema, Corte de Apelaciones, and lower court decisions is limited; do not rely solely on this for jurisprudence research (investigación jurisprudencial)
2. **Historical statute versions** -- Limited availability of historical provision wording (texto histórico de la ley)
3. **Legal commentary** -- No editorial annotations (comentarios), academic commentary (doctrina), or practice guides
4. **Unpublished decisions** -- Lower court decisions and administrative rulings (resoluciones exentas) largely absent
5. **Full legislative history** -- Limited coverage of parliamentary materials (boletines, informes de comisión, historia fidedigna)
6. **Regulatory instructions** -- Circulars and instructions from regulators such as CMF, SII, or Contraloría may be missing
...
- **International Law Blind Spots**: Cannot fully assess obligations under international treaties or free trade agreements Chile has ratified
...
- Provide competent representation (diligencia debida)

## Recommended Workflow for Professional Use

1. **Initial Research**: Use Tool for preliminary research and hypothesis generation
2. **Official Verification**: Cross-check ALL results with official sources (bcn.cl)
3. **Commercial Databases**: Use professional legal databases (LegalPublishing, Abeledo Perrot) for authoritative, annotated versions
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Chilean-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Chilean-law-mcp/issues
...
- **ALWAYS VERIFY** all legal information with official sources (Biblioteca del Congreso Nacional — bcn.cl)
...
- **COMPLY** with Colegio de Abogados de Chile professional ethics rules regarding AI tool use and client confidentiality
